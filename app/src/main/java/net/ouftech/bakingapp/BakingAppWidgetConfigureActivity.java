 ...
 */
public class BakingAppWidgetConfigureActivity extends MainActivity {

    private static final String PREFS_NAME = "net.ouftech.bakingapp.BakingAppWidgetProvider";
